...
if (document.documentElement) {
  insertResponsiveExtras();
} else {
  window.addEventListener("DOMContentLoaded", insertResponsiveExtras);
}

function insertResponsiveExtras() {
  if (window.location.hostname.indexOf("irccloud") < 0) {
    // Just making sure..
    return;
  }

  if (document.documentElement.dataset.responsiveAddon) {
    return;
  }

  document.documentElement.dataset.responsiveAddon = true;
